 ...
 *
 * @method \DocsLab\IPay88\Message\PaymentRequestMessage getMessage()
 *
 * @author Maxime Gilbert (DocBu) <docbu@docslab.net>
 */
class PaymentRequestEvent extends EventAbstract {

  /**
   * {@inheritdoc}
   */
  const EVENT_NAME = Events::PAYMENT_REQUEST;

  /**
   * {@inheritdoc}
   */
  const RELATED_EVENT_CLASS = PaymentResponseEvent::class;
