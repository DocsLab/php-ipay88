...
/**
 * The payment status request event.
 *
 * @see \DocsLab\IPay88\Events
 * @see \DocsLab\IPay88\Message\PaymentStatusRequestMessage
 *
 * @method \DocsLab\IPay88\Message\PaymentStatusRequestMessage getMessage()
 *
 * @author Maxime Gilbert (DocBu) <docbu@docslab.net>
 */
class PaymentStatusRequestEvent extends EventAbstract {

  /**
   * {@inheritdoc}
   */
  const EVENT_NAME = Events::PAYMENT_STATUS_REQUEST;

  /**
   * {@inheritdoc}
   */
  const RELATED_EVENT_CLASS = PaymentStatusResponseEvent::class;
