...
/**
 * The payment notify response event.
 *
 * @see \DocsLab\IPay88\Events
 * @see \DocsLab\IPay88\Message\PaymentNotifyResponseMessage
 *
 * @method \DocsLab\IPay88\Message\PaymentNotifyResponseMessage getMessage()
 *
 * @author Maxime Gilbert (DocBu) <docbu@docslab.net>
 */
class PaymentNotifyResponseEvent extends EventAbstract {

  /**
   * {@inheritdoc}
   */
  const EVENT_NAME = Events::PAYMENT_NOTIFY_RESPONSE;
